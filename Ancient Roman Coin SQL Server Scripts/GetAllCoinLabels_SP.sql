...
-- =============================================
CREATE PROCEDURE [dbo].[GetAllCoinLabels_sp] 
AS
BEGIN
   ...
   select coin_id, issuing_authority_name, obverse_legend, reverse_legend, exergue, mint_name, description from [Ancient Roman Coins].dbo.tblCoins c
